...
def view():
    if not contacts:
        ...
        # This prints the table with vertical lines using tabulate
        print(tabulate(
            table_data,
            headers=["S.No", "NAME", "PHONE NUMBER", "EMAIL"],
            tablefmt="grid"  # "grid" format adds vertical and horizontal lines
        ))
